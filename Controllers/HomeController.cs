...
namespace POC_Fawry.Controllers {
    public class HomeController : Controller {
        ...
        public HomeController(FawryService paymobService, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var clientSecret = await _fawryService.GetClientSecretAsync(order,true);
